...
function NewAppointment() {
  ...
  const [time, setTime] = useState<Date>(() => roundUpTo15(new Date()));
      ...
      <div className="flex-1 px-4 overflow-y-auto pb-32">
        ...
        <Section label="Hora">
          ...
          <div className="mt-2 grid grid-cols-2 gap-2">
            <button type="button" onClick={() => setTime(roundUpTo15(new Date()))} className="h-11 rounded-xl bg-muted hairline text-sm active:scale-95 transition-transform">Ahora</button>
